...
public class VentaEntradaController implements Serializable {
    ...
    @EJB
    private dao.VentaEntradaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/vistas").getString("VentaEntradaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/vistas").getString("VentaEntradaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/vistas").getString("VentaEntradaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public VentaEntrada getVentaEntrada(java.lang.Integer id) {

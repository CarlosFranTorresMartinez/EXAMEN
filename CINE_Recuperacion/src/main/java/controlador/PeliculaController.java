...
public class PeliculaController implements Serializable {
    ...
    @EJB
    private dao.PeliculaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/vistas").getString("PeliculaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/vistas").getString("PeliculaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/vistas").getString("PeliculaDeleted"));
        if (!JsfUtil.isValidationFailed()) {

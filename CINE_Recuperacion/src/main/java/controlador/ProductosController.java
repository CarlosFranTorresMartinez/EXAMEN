...
public class ProductosController implements Serializable {
    ...
    @EJB
    private dao.ProductosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/vistas").getString("ProductosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/vistas").getString("ProductosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/vistas").getString("ProductosDeleted"));
        if (!JsfUtil.isValidationFailed()) {

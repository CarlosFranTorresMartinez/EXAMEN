...
public class ComboController implements Serializable {
    ...
    @EJB
    private dao.ComboFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/vistas").getString("ComboCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/vistas").getString("ComboUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/vistas").getString("ComboDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Combo getCombo(java.lang.Integer id) {
